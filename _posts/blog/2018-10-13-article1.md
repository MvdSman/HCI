...
A city itself influences the contours of its [flu](HCI/Rsc/Art1/flu){:target="DictionaryFrame"} season – whether [flu]({{ site.urldict }}flu) cases rise to a wintertime peak or plateau from fall to spring, new research suggests.
